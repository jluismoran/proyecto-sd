	...
	public function actionGuardar()
	{
		...
		if(isset($_POST['guardar_deuda']))
		{
		    ...
		    if(!$total)
			{
			   ...
			   $items = $_POST['lista_deudas']; //almacena en un array los importes seleccionados
