...
$this->menu=array(
	array('label'=>'Exportar en PDF', 'url'=>array('exportarplantilla2','id'=>$model->deuda_id)),
);
?>
<table width="800" height="343" border="0" align="center">
  ...
  <tr>
    ...
    <strong><?php echo $model->complementoDocumento->plantilla->campo9;?></strong> <?php echo$model->nro_expediente;?> <?php echo $model->complementoDocumento->plantilla->campo10;?><br>
    <p>&nbsp;</p>
	</td>
  </tr>
  <tr>
    <td><strong><?php echo $model->complementoDocumento->plantilla->campo13;?></strong><br>
    <?php echo $model->complementoDocumento->plantilla->campo14;?> <?php echo date('d-m-Y');?><br>
	&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3"><p align="justify">
	<?php echo $model->complementoDocumento->plantilla->campo15;?> 
	<strong><?php echo $model->complementoDocumento->plantilla->campo16;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo17;?> <strong><?php echo $model->cliente->descripcion1.' '.$model->cliente->descripcion2;?></strong> 
	...
	<strong><?php echo $model->complementoDocumento->plantilla->campo21;?> <?php echo $model->importe;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo23;?> 
	<strong><?php echo $model->cliente->direccion;?> <?php echo $model->cliente->distrito->descripcion;?> <?php echo $model->complementoDocumento->plantilla->campo24;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo25;?> <strong><?php echo $model->complementoDocumento->plantilla->campo26;?></strong> 
...
<table width="800" height="343" border="0" align="center">
    <tr>
    <td height="100" colspan="3" align="left"><h4><strong><?php echo $model->complementoDocumento->plantilla->descripcion;?></strong></h4>
	  <h4><?php echo $model->complementoDocumento->plantilla->descripcion2;?></h4>
      <h4><?php echo $model->complementoDocumento->plantilla->campo0;?></h4>
  ...
  <td width="300"></td>
    ...
    <strong><?php echo $model->complementoDocumento->plantilla->campo6." ".$model->complementoMateria->descripcion;?></strong> Impuesto Predial <?php echo $model->periodo;?><br>
