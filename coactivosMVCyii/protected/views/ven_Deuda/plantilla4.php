...
$this->menu=array(
	array('label'=>'Exportar en PDF', 'url'=>array('Exportarplantilla4','id'=>$model->deuda_id)),
);
?>
<table width="800" height="343" border="0" align="center">
  ...
  <tr>
	...
	<?php echo $model->complementoDocumento->plantilla->campo14;?> 
	...
	<?php echo $model->complementoDocumento->plantilla->campo20;?> 
	<strong><?php echo $model->complementoDocumento->plantilla->campo21;?></strong>  
	<?php echo $model->complementoDocumento->plantilla->campo22;?> 
	<strong><?php echo $model->complementoDocumento->plantilla->campo23;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo24;?> 
	<strong><?php echo $model->complementoDocumento->plantilla->campo25;?></strong> 
    <?php echo $model->complementoDocumento->plantilla->campo26;?> 
	<strong><?php echo $model->cliente->descripcion1.' '.$model->cliente->descripcion2;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo27;?> 
	<strong><?php echo $model->complementoDocumento->plantilla->campo28;?></strong> 
	<?php echo $model->complementoDocumento->plantilla->campo29;?> <strong><?php echo $model->importe;?></strong>
	<?php echo $model->complementoDocumento->plantilla->campo30;?> <?php echo $model->usuario->cliente->descripcion1.' '.$model->usuario->cliente->descripcion2;?> <?php echo $model->complementoDocumento->plantilla->campo31;?>
	</td>
  </tr>
</table>
...
<table width="800" height="343" border="0" align="center">
  <tr>
    ...
    <strong><?php echo $model->complementoDocumento->plantilla->campo3;?></strong> <?php echo $model->cliente->direccion;?><br>
	</td>
  </tr>
  <tr>
    <td width="300"></td>
...
<table width="800" height="343" border="0" align="center">
  ...
  <tr>
    <td colspan="3" align="center"><p>&nbsp;</p><p>&nbsp;</p><strong><?php echo $model->complementoDocumento->plantilla->campo32;?></strong><p>&nbsp;</p></td>
  </tr>
  <tr>
    <td colspan="3"><p> <?php echo $model->complementoDocumento->plantilla->campo33;?> <?php echo '.....................';//date('d-m-Y');?> <?php echo $model->complementoDocumento->plantilla->campo34;?> <?php echo '....................';//date('H:i:s');?> 
	<?php echo $model->complementoDocumento->plantilla->campo35;?></br><p>&nbsp;</p>
      <?php echo $model->complementoDocumento->plantilla->campo36;?> <?php echo '............................................................................';//$model->cliente->descripcion1.' '.$model->cliente->descripcion2;?><br /><p>&nbsp;</p>
      <?php echo $model->complementoDocumento->plantilla->campo38;?> <?php echo '.....................';//$model->cliente->nro_identificacion;?> <?php echo $model->complementoDocumento->plantilla->campo37;?> .................................................<br /><p>&nbsp;</p>
      <?php echo $model->complementoDocumento->plantilla->campo39;?> 
	  &nbsp;&nbsp;&nbsp;
...........................................................................................................<p><br></p>
...
...........................................................................................................<br /><p>&nbsp;</p>
 ...
 <table width="800" height="343" border="0" align="center">
  ...
  <tr>
	...
	<p><?php echo $model->complementoDocumento->plantilla->campo40;?> ................................................................................................................<br /><p>&nbsp;</p>
	   <?php echo $model->complementoDocumento->plantilla->campo41;?> ............................................................<br /><p>&nbsp;</p>
	   <?php echo $model->complementoDocumento->plantilla->campo42;?> .........................................................
	</p>
	</td>
  </tr>
</table>