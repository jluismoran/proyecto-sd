...
/**
 * CambioResponsable generated by hbm2java
 */
@Entity
@Table(name = "CAMBIO_RESPONSABLE", schema = "dbo", catalog = "SISMAV2")
public class CambioResponsable implements java.io.Serializable {

	private CambioResponsableId id;
	...
	public CambioResponsable() {
	}

	public CambioResponsable(CambioResponsableId id, Tecnico tecnico,
			Cambio cambio) {
		this.id = id;
	...
	public CambioResponsable(CambioResponsableId id, Tecnico tecnico,
			Cambio cambio, Integer estado, String usuarioCreacion,
	...
	public CambioResponsableId getId() {
		return this.id;
	}

	public void setId(CambioResponsableId id) {
		this.id = id;
	}
