...
/**
 * CambioProblema generated by hbm2java
 */
@Entity
@Table(name = "CAMBIO_PROBLEMA", schema = "dbo", catalog = "SISMAV2")
public class CambioProblema implements java.io.Serializable {

	private CambioProblemaId id;
	...
	public CambioProblema() {
	}

	public CambioProblema(CambioProblemaId id, Cambio cambio, Problema problema) {
		this.id = id;
		this.cambio = cambio;
		this.problema = problema;
	}

	public CambioProblema(CambioProblemaId id, Cambio cambio,
	...
	public CambioProblemaId getId() {
		return this.id;
	}

	public void setId(CambioProblemaId id) {
		this.id = id;
	}
