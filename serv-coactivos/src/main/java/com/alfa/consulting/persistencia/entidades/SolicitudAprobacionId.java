...
/**
 * SolicitudAprobacionId generated by hbm2java
 */
@Embeddable
public class SolicitudAprobacionId implements java.io.Serializable {
	...
	public SolicitudAprobacionId() {
	}

	public SolicitudAprobacionId(int codigoSolicitud,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SolicitudAprobacionId))
			return false;
		SolicitudAprobacionId castOther = (SolicitudAprobacionId) other;
