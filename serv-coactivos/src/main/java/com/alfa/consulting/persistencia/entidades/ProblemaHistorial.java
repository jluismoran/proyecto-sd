...
/**
 * ProblemaHistorial generated by hbm2java
 */
@Entity
@Table(name = "PROBLEMA_HISTORIAL", schema = "dbo", catalog = "SISMAV2")
public class ProblemaHistorial implements java.io.Serializable {

	private ProblemaHistorialId id;
	...
	public ProblemaHistorial() {
	}

	public ProblemaHistorial(ProblemaHistorialId id, Problema problema) {
		this.id = id;
		this.problema = problema;
	}

	public ProblemaHistorial(ProblemaHistorialId id, Problema problema,
			String descripcionHistorial, Integer propiedad, Integer estado,
	...
	public ProblemaHistorialId getId() {
		return this.id;
	}

	public void setId(ProblemaHistorialId id) {
		this.id = id;
	}
	...
	@Column(name = "descripcionHistorial", length = 500)
