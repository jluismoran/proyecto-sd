 ...
 */
@Entity
@Table(name = "NOTA", schema = "dbo", catalog = "SISMAV2")
public class Nota implements java.io.Serializable {
	...
	public Nota(NotaId id, Solicitud solicitud) {
		this.id = id;
		this.solicitud = solicitud;
	}

	public Nota(NotaId id, Solicitud solicitud, String nota, Integer estado,
