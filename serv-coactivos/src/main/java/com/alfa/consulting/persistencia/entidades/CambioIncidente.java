...
/**
 * CambioIncidente generated by hbm2java
 */
@Entity
@Table(name = "CAMBIO_INCIDENTE", schema = "dbo", catalog = "SISMAV2")
public class CambioIncidente implements java.io.Serializable {

	private CambioIncidenteId id;
	...
	public CambioIncidente() {
	}

	public CambioIncidente(CambioIncidenteId id, Solicitud solicitud,
			Cambio cambio) {
		this.id = id;
	...
	public CambioIncidenteId getId() {
		return this.id;
	}

	public void setId(CambioIncidenteId id) {
		this.id = id;
	}
