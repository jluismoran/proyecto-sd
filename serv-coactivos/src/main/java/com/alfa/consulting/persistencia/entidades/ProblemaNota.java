...
/**
 * ProblemaNota generated by hbm2java
 */
@Entity
@Table(name = "PROBLEMA_NOTA", schema = "dbo", catalog = "SISMAV2")
public class ProblemaNota implements java.io.Serializable {

	private ProblemaNotaId id;
	...
	public ProblemaNota(ProblemaNotaId id, Problema problema) {
		this.id = id;
		this.problema = problema;
	}

	public ProblemaNota(ProblemaNotaId id, Problema problema, String nota,
	...
	public ProblemaNotaId getId() {
		return this.id;
	}

	public void setId(ProblemaNotaId id) {
		this.id = id;
	}
